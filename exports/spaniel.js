(function(global, factory) {
  ...
  /*
    ...
    WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.
    */
  var emptyRect$1 = { x: 0, y: 0, width: 0, height: 0 };
        ...
        _this.handleThresholdExiting(
          {
            ...
            boundingClientRect: boundingClientRect || emptyRect$1,
  ...
  var Watcher = /** @class */ (function() {
    function Watcher(config) {
      ...
      var time = config.time,
        ...
        BACKGROUND_TAB_FIX = config.BACKGROUND_TAB_FIX,
        USE_NATIVE_IO = config.USE_NATIVE_IO;
      var threshold = [
        {
          label: 'exposed',
          time: 0,
  ...
  /*
    ...
    WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.
    */
  var IntersectionObserver = !!W.IntersectionObserver ? W.IntersectionObserver : SpanielIntersectionObserver;
...
//# sourceMappingURL=spaniel.js.map
